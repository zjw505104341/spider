...
console.log(sdc('acs2f7efe14m7beljfulu6500743748062061') );
...
function get_pwd(sessionCookie, randomYes, pwd) {
    var randomId = encrypt(pwd, sdc(sessionCookie + randomYes));
    var password = randomId + randomYes;
    return password
}

console.log(get_pwd('5h386gainjo5539onu0sb2it63', '43748042151', '123456'))



//   这里是关键js 代码  document.on   事件监听   监听   click(点击)  .btnCrypt  (class=btnCrypy)  触发下面的函数
// (function anonymous() {
// 	function encrypt(text, secKey) {
//             var key = CryptoJS.enc.Utf8.parse(secKey);
// 	    var srcs = CryptoJS.enc.Utf8.parse(text);
...
// 	    return encrypted.toString();
// 	}
// 	$(document).on("click",".btnCrypt",function(){
//             var cryptStr = $(".cryptStr").val();
//             var randomYes = $.cookie('randomYes') || "undefined";
//             if(cryptStr.indexOf(randomYes)>0){
//                     return;
//             }
//             if($.cookie('line')){
//                 var sessionCookie = $.cookie('line');
//             }else if($.cookie('admin')){
//                 var sessionCookie = $.cookie('admin');
//             }else{
//                 var sessionCookie = $.cookie('web');
//             }
